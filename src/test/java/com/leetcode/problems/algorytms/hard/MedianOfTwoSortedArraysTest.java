...
public class MedianOfTwoSortedArraysTest {
    ...
    public void whitSameElements() throws Exception {
        MedianOfTwoSortedArrays medianOfTwoSortedArrays = new MedianOfTwoSortedArrays();
        Assert.assertEquals(3, medianOfTwoSortedArrays.findMedianSortedArrays(new int[]{1, 3}, new int[]{3, 5}), 0);
        Assert.assertEquals(1.5, medianOfTwoSortedArrays.findMedianSortedArrays(new int[]{1, 2}, new int[]{1, 2}), 0);
    }
