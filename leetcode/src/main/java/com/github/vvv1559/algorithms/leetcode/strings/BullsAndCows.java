 ...
 * Bulls and Cows
 *
 * Original text: https://leetcode.com/problems/bulls-and-cows/
 *
 ...
 * said guess match your secret number exactly in both digit and position (called &quot;bulls&quot;) and how many digits
 * match the secret number but locate in the wrong position (called &quot;cows&quot;). Your friend will use successive
